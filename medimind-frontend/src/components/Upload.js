    ...
    <div style={{ marginBottom: 40 }}>
      ...
      >
        ...
        <div style={{
          ...
          background: "linear-gradient(135deg,rgba(24,71,240,0.3),rgba(0,212,255,0.2))",
          border: "1px solid rgba(0,212,255,0.2)",
          display: "flex", alignItems: "center", justifyContent: "center",
          fontSize: 32, boxShadow: "0 0 40px rgba(24,71,240,0.2)"
        }}>
          {loading ? "⏳" : "📄"}
        </div>
        ...
        <div style={{ fontSize: 14, color: "rgba(232,237,248,0.4)", marginBottom: 28 }}>
          {loading
            ? "Extracting entities → Predicting risks → Generating summary..."
            : "Drag & drop or click to upload. Supports discharge summaries, lab reports, clinical notes."}
        </div>
        ...
        {loading ? (
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12 }}>
            ...
            <span style={{ fontSize: 13, color: "#00d4ff", fontFamily: "'JetBrains Mono',monospace" }}>
              Processing with BioBERT + Claude API...
            </span>
          </div>
        ) : (
          <button
            ...
            style={{
              background: "linear-gradient(135deg,#1847f0,#0f3dd4)",
              color: "white", border: "none", padding: "14px 36px",
              borderRadius: 12, fontSize: 15, fontWeight: 600,
              cursor: "pointer", fontFamily: "'DM Sans',sans-serif",
              boxShadow: "0 0 32px rgba(24,71,240,0.4)"
            }}
          >
            ⬆ Choose Medical PDF
          </button>
      ...
      {fileName && (
        <div style={{
          ...
          borderRadius: 10, padding: "10px 16px", width: "fit-content", margin: "0 auto",
          fontSize: 13, fontFamily: "'JetBrains Mono',monospace", color: "rgba(232,237,248,0.5)"
        }}>
          📎 {fileName}
